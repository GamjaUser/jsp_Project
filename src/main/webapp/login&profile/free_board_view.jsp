...
<body>
    ...
    <tr>
        <td colspan="4" align="center">
            <button type="button" class="custom-btn1 btn-4" onclick="location.href='../mvcboard/edit.do?idx=${ param.idx }';">
                수정하기
            </button>
            <button type="button" class="custom-btn1 btn-4" onclick="location.href='../mvcboard/delete.do?idx=${ param.idx }';">
                삭제하기
            </button>
            <button type="button" class="custom-btn1 btn-4" onclick="location.href='../mvcboard/list.do';">
                목록 바로가기
            </button>
            <button type="button" class="custom-btn1 btn-4" id="commentLook_btn" onclick="openCommentPopup(${dto.idx});">
			    댓글 보기
			</button>
        </td>
    </tr>
...
<!-- 모달 창 -->
<div id="commentModal" style="display:none; position:fixed; top:50%; left:50%; transform:translate(-50%, -50%); width:80%; max-width:600px; height:700px; background:#fff; z-index:1001; overflow:auto;">
